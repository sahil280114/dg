...
def process_variables_batch_job(string_template, variables_dict):
...
def format_prompt_data_gen_conditional(use_case: str,input_format:str,output_format:str,keyword:str="",web_doc:str="",condition:str="") -> str:
    """
    Formats a prompt for generating search terms related to a specific use case.
    ...
    """
    if keyword!="":
        base_prompt = f'''You are generating data which will be used to train a machine learning model.\n\nYou will be given a high-level description of the model we want to train which contains information about the use case and requirements,the format of inputs, the format of outputs and from that, you will generate one data sample, with a prompt/response pair.\n\nYou will do so in this format:\n```\nprompt\n-----------\n$prompt_goes_here\n-----------\n\nresponse\n-----------\n$response_goes_here\n-----------\n```\n\n\nFor each turn, make the example slightly more complex than the last, while ensuring diversity.\n\nMake sure your samples are unique and diverse, yet high-quality and complex enough to train a well-performing model. Change the diversity of output each turn based on previous ones.\n\nHere is the use case of the model we want to train:\n```{use_case}```.\n Here's the input format:\n```{input_format}```\n Here's the output format:\n```{output_format}```. \n The input and output format is defined as text within which there are variables defined within <glaive_variable> tags. Generate information for these variables following the description,type and size guidelines mentioned. Do not deviate from that. Do not put any of these xml tags in outputs.  In this context, generate sample on the following topic within the usecase- {keyword}.\nDo not repeat previous generated samples, make it different. /n/n The user has given you the following conditon, make sure this condition is met in the sample generated. The condtion is more important that anything said before- \n {condition}'''
        return base_prompt
    elif web_doc!="":
        base_prompt = f'''You are generating data which will be used to train a machine learning model.\n\nYou will be given a high-level description of the model we want to train which contains information about the use case and requirements,the format of inputs, the format of outputs and from that, you will generate one data sample, with a prompt/response pair.\n\nYou will do so in this format:\n```\nprompt\n-----------\n$prompt_goes_here\n-----------\n\nresponse\n-----------\n$response_goes_here\n-----------\n```\n\n\nFor each turn, make the example slightly more complex than the last, while ensuring diversity.\n\nMake sure your samples are unique and diverse, yet high-quality and complex enough to train a well-performing model. Change the diversity of output each turn based on previous ones.\n\nHere is the use case of the model we want to train:\n```{use_case}```.\n Here's the input format:\n```{input_format}```\n Here's the output format:\n```{output_format}```. \n The input and output format is defined as text within which there are variables defined within <glaive_variable> tags. Generate information for these variables following the description,type and size guidelines mentioned. Do not deviate from that. Do not put any of these xml tags in outputs. Use the following text from a website to generate the sample, if web text is irrelevant to the usecase then ignore it. - {web_doc}./n/n The user has given you the following conditon, make sure this condition is met in the sample generated. The condtion is more important that anything said before- \n {condition}'''
        return base_prompt
    base_prompt = f'''You are generating data which will be used to train a machine learning model.\n\nYou will be given a high-level description of the model we want to train which contains information about the use case and requirements,the format of inputs, the format of outputs and from that, you will generate one data sample, with a prompt/response pair.\n\nYou will do so in this format:\n```\nprompt\n-----------\n$prompt_goes_here\n-----------\n\nresponse\n-----------\n$response_goes_here\n-----------\n```\n\n\nFor each turn, make the example slightly more complex than the last, while ensuring diversity.\n\nMake sure your samples are unique and diverse, yet high-quality and complex enough to train a well-performing model. Change the diversity of output each turn based on previous ones.\n\nHere is the use case of the model we want to train:\n```{use_case}```.\n Here's the input format:\n```{input_format}```\n Here's the output format:\n```{output_format}```. \n The xml tags with <glaive_variable> are variables where you will put generated information of the given type and size. Do not include those tags in samples. Wherever possbile generate a diversity of variable types./n/n The user has given you the following conditon, make sure this condition is met in the sample generated. The condtion is more important that anything said before- \n {condition}'''
    return base_prompt
